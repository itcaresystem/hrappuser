...
import ride.happyy.user.model.CountryListBean;
...
public class AppConstants {
    ...
    public static final String FEEDBACK1 = App.getInstance().getResources().getString(R.string.label_i_lost_an_item);
    public static final String FEEDBACK2 = App.getInstance().getResources().getString(R.string.label_i_was_incorrectly_charged_cancellation_fee);
    public static final String FEEDBACK3 = App.getInstance().getResources().getString(R.string.label_i_would_like_a_refund);
    public static final String FEEDBACK4 = App.getInstance().getResources().getString(R.string.feedback_my_driver_was_unprofessional);
    public static final String FEEDBACK5 = App.getInstance().getResources().getString(R.string.feedback_my_vehicle_wasn_t_what_i_expected);
    public static final String FEEDBACK6 = App.getInstance().getResources().getString(R.string.label_i_had_an_issue_with_reciept_or_payment);

    public static final String BAD_FEEDBACK_TYPE_SERVICE = App.getInstance().getResources().getString(R.string.feedback_bad_service);
    public static final String BAD_FEEDBACK_TYPE_CLEANLINESS = App.getInstance().getResources().getString(R.string.feedback_bad_cleanliness);
    public static final String BAD_FEEDBACK_TYPE_DRIVING = App.getInstance().getResources().getString(R.string.feedback_bad_driving);
    public static final String BAD_FEEDBACK_TYPE_COMFORT = App.getInstance().getResources().getString(R.string.feedback_bad_comfort);
    public static final String BAD_FEEDBACK_TYPE_CAR_QUALITY = App.getInstance().getResources().getString(R.string.feedback_bad_car_quality);
    public static final String BAD_FEEDBACK_TYPE_OTHER = App.getInstance().getResources().getString(R.string.feedback_bad_other);
    public static final String GOOD_FEEDBACK_TYPE_SERVICE = App.getInstance().getResources().getString(R.string.feedback_good_service);
    public static final String GOOD_FEEDBACK_TYPE_CLEANLINESS = App.getInstance().getResources().getString(R.string.feedback_good_cleanliness);
    public static final String GOOD_FEEDBACK_TYPE_DRIVING = App.getInstance().getResources().getString(R.string.feedback_good_driving);
    public static final String GOOD_FEEDBACK_TYPE_COMFORT = App.getInstance().getResources().getString(R.string.feedback_good_comfort);
    public static final String GOOD_FEEDBACK_TYPE_CAR_QUALITY = App.getInstance().getResources().getString(R.string.feedback_good_car_quality);
    public static final String GOOD_FEEDBACK_TYPE_OTHER = App.getInstance().getResources().getString(R.string.feedback_good_other);

    //    public static String WEB_ERROR_MSG = "Unable to connect to the server. Please try again later";
    public static String WEB_ERROR_MSG = App.getInstance().getResources().getString(R.string.message_web_error_msg);
